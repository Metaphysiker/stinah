...
RSpec.describe "home_requests/new", type: :view do
  before(:each) do
    assign(:home_request, HomeRequest.new(
      :are_you_owner => false,
  ...
  it "renders new home_request form" do
    render

    assert_select "form[action=?][method=?]", home_requests_path, "post" do
