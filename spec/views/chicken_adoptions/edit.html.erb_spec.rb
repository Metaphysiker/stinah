...
RSpec.describe "chicken_adoptions/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit chicken_adoption form" do
    render

    assert_select "form[action=?][method=?]", chicken_adoption_path(@chicken_adoption), "post" do
